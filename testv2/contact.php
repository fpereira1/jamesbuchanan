...
<div id="inner-wrap">
    ...
    <header id="top" role="banner">
        <div class="block">
             <h1 class="block-title"><a href="index.html">James Buchanan</a></h1>
...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1"> 
     ...
     <input name="email_r" type="text" class="required email speech-bubble form-input"autocapitalize="off" autocorrect="off" autocomplete="off" size="30" placeholder="Email" /> 
...
?> 
 ...
 <ul class="intro">
	<li>0274608712</li>
	<li><a href="mailto:james.nzdesign@gmail.com">james.nzdesign@gmail.com</a></li>
</ul>    
  ...
  <a href="https://www.facebook.com/james.buchanan.397"><i class="icon-facebook icon-padding"> </i></a>
            <span class="pull-right copyright">&copy; James Buchanan 2013</span>
        </div>
    </footer>
...
$(document).ready(function() {
    ...
    <script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-26363073-1']);
